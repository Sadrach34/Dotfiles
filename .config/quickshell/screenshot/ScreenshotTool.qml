...
PanelWindow {
    ...
    Component.onCompleted: {
        if (SsState.screenshotToolVisible) {
            open();
        }
    }

    property string currentMode: SsState.screenshotCaptureMode

    onCurrentModeChanged: {
        if (SsState.screenshotCaptureMode !== currentMode) {
            SsState.screenshotCaptureMode = currentMode
        }
    ...
    Connections {
        ...
        function onScreenshotCaptureModeChanged() {
            if (screenshotPopup.currentMode !== SsState.screenshotCaptureMode) {
                screenshotPopup.currentMode = SsState.screenshotCaptureMode
            }
        }
    }
    ...
    function open() {
        ...
        SsState.screenshotCaptureMode = "region";
    ...
    function close() {
        ...
        SsState.screenshotToolVisible = false;
    }
    ...
    FocusScope {
        ...
        Rectangle {
            ...
            width: barRow.width + 32
            height: barRow.height + 32
            ...
            Row {
                ...
                // Botón para abrir grabación de pantalla
                Rectangle {
                    id: recordBtn
                    anchors.verticalCenter: parent.verticalCenter
                    width: 48
                    ...
                    color: recordBtnHover.containsMouse ? Styling.srItem("focus") : "transparent"
                    ...
                    Text {
                        ...
                        font.pixelSize: 24
                        color: recordBtnHover.containsMouse ? Styling.srItem("overprimary") : Colors.overBackground
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }

                    StyledToolTip {
                        show: recordBtnHover.containsMouse
                        tooltipText: "Grabar pantalla"
                    }
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            SsState.screenRecordToolVisible = true;
                        }
                    }
                }
            }
